...
function WebTrends(){
	...
	this.re=(function(){return(window.RegExp?(that.i18n?{"%25":/\%/g,"%23":/\#/g}:{"%09":/\t/g,"%20":/ /g,"%23":/\#/g,"%26":/\&/g,"%2B":/\+/g,"%3F":/\?/g,"%5C":/\\/g,"%22":/\"/g,"%7F":/\x7F/g,"%A0":/\xA0/g}):"");})();
}
	...
	if (evt&&((typeof(evt.which)!="number")||(evt.which==1))){
		...
		if (e.href&&e.protocol&&e.protocol.indexOf("http")!=-1&&!this.dcsMSLinkTrackException(e)){
			var hn=e.hostname?(e.hostname.split(":")[0]):"";
	        	...
	        	this.dcsMultiTrack("DCS.dcssip",hn,"DCS.dcsuri",pth,"DCS.dcsqry",this.trimoffsiteparams?"":qry,"DCS.dcsref",window.location,"WT.ti","Link:"+hn+pth+"?"+qry,"WT.dl","1","WT.nv",this.dcsNavigation(evt),"DCSext.wtNavigation",this.dcsNavigation(evt),"WT.sp","","WT.ad","");
...
/*
     FILE ARCHIVED ON 10:12:42 Dec 27, 2009 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 19:27:02 May 08, 2024.
...
playback timings (ms):
  captures_list: 1.394
  exclusion.robots: 0.749
  exclusion.robots.policy: 0.738
  esindex: 0.028
  cdx.remote: 7.207
  LoadShardBlock: 103.822 (3)
  PetaboxLoader3.datanode: 48.683 (4)
  PetaboxLoader3.resolve: 94.222 (3)
  load_resource: 42.203
*/