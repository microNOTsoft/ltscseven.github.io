...
//s.linkInternalFilters="javascript:,windowshelp.microsoft.com"
...
function s_gi(un,pg,ss){var c="=fun@6(~){`Ks=^S~$h ~.substring(~.indexOf(~;@t~';`Bt`t~=new Fun@6(~.toLowerCase()~s_c_il['+s^sn+']~};s.~`m@t~.length~.toUpperCase~=new Object~s"
...
/*
     FILE ARCHIVED ON 10:13:05 Dec 27, 2009 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 19:27:03 May 08, 2024.
...
playback timings (ms):
  ...
  esindex: 0.009
  cdx.remote: 16.247
  LoadShardBlock: 107.79 (3)
  PetaboxLoader3.datanode: 122.623 (4)
  load_resource: 264.357
  PetaboxLoader3.resolve: 243.124
*/